...
//abstraction in abstract classess 0-100%
...
public abstract class Finance implements USBank,CBCBank {
   ...
   public abstract void tradingAccouts();

    public void commerceAccounts(){

        System.out.println("HSBC bank do Commerce accounts");
