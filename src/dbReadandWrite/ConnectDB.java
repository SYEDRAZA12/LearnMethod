...
import dbReadandWrite.Student;
import dbReadandWrite.User;
...
//    }
    ...
    public void insertDataFromArrayListToSqlTable(List<Student> list, String tableName, String columnName) {
        try {
            ...
            e.printStackTrace();
            System.out.println("insertDataFromArrayListToSqlTable is not working!!!!!!!!!!");
        } catch (SQLException e) {
            e.printStackTrace();
        } catch (ClassNotFoundException e) {
...
//
        ...
        Student shakir = new Student("Shakir","Jahangir","AAA","001");
        Student mobin = new Student("mobin","abdullah","ABA","002");
        Student sumetra = new Student("Suemetra","Debnath","ACA","003");
...
//
        ...
        //connectDB.insertDataFromArrayListToSqlTable();
        connectDB.insertDataFromArrayListToSqlTable(st,"students","firstName");
